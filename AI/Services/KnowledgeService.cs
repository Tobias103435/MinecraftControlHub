...
public class KnowledgeService : IKnowledgeService
{
    ...
    public async Task<string> BuildSystemPromptAsync()
    {
        ...
        return
            "You are the AI assistant for Minecraft Control Hub — a Minecraft launcher and server manager.\n" +
            "Your job is to help users manage their Minecraft installations, mods, and servers through natural language.\n\n" +
            "## HARD RULES\n" +
